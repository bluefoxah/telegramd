...
func (*ServerAuthReq) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{0} }
...
func (*VoidRsp) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{1} }
...
func (*DeliveryUpdatesToUsers) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{2} }
...
func (*PushUpdatesData) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{3} }
...
func init() { proto.RegisterFile("sync.proto", fileDescriptor1) }
